...
from .zoom_to_dep_dialog import ZoomToDepDialog
import os.path
...
class ZoomToDep:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Zoom to Department')
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Zoom sur departement'),
            callback=self.run,
